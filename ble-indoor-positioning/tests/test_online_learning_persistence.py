...
def test_online_learning_persistence(tmp_path):
    ...
    assert abs(new_learner.anchor_eta['ANCHOR_01'] - learner.anchor_eta['ANCHOR_01']) < 0.0001
    assert abs(new_learner.anchor_bias['ANCHOR_01'] - learner.anchor_bias['ANCHOR_01']) < 0.0001
