...
def test_room_name_hysteresis():
    ...
    # Slight shift near boundary should maintain hysteresis
    res = resolve_room_name_with_hysteresis(5.1, 5.1, current)
    assert res == current

    # Large shift into Emergency Ward
...
def test_geofence_alert_trigger():
    ...
    # 1. ICU Exit to Emergency Ward -> HIGH severity
