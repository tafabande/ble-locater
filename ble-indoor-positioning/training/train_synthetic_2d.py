"""
BLE Indoor Positioning — Direct 2D Multi-Anchor Position Regressor Trainer
===========================================================================
Trains a Direct 2D Position Estimator (predicting X, Y coordinates directly 
from multi-anchor RSSI combinations logged during Unity simulation runs).
"""
...
def main():
    ...
    # Pivot packets into observation windows by timestamp & ground truth coordinates
    ...
    for anc in required_anchors:
        if anc not in pivoted.columns:
            pivoted[anc] = -95.0 # Fallback RSSI if missing
